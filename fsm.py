...
class TocMachine(GraphMachine):
    ...
    def on_enter_state_sponsor(self, event):
        ...
        sender_id = event['sender']['id']
        send_image_url(sender_id, "https://anfansy.files.wordpress.com/2015/10/1211790456.gif")
    ...
    def on_enter_state_price1(self, event):
        ...
        sender_id = event['sender']['id']
        send_text_message(sender_id, "黃區的票價為$800\n是否確認購買(確認購買)")
    ...
    def on_enter_state_price2(self, event):
        ...
        sender_id = event['sender']['id']
        send_text_message(sender_id, "紅區的票價為$500\n是否確認購買(確認購買)")
    ...
    def on_enter_state_price3(self, event):
        ...
        sender_id = event['sender']['id']
        send_text_message(sender_id, "藍區的票價為$300\n是否確認購買(確認購買)")
